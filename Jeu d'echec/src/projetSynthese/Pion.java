...
public class Pion extends Piece {
	...
	public boolean estValide(Deplacement deplacement) {
		 ...
		 * est egal ˆ un ou deux en fonction de la position du pion. (les operateurs <= et >= servent a valider le cas que le pion
		 * avancent d'une seule case et ce m?me si il est sur la ligne de depart.
		 */
		if (deplacement.getDeplacementX() == 0)
			if (this.getCouleur().equals("noir")){
				/*si le deplacementY est plus petit ou egal a 2 si la ligne de depart est egal ˆ 1, a 1 si la ligne de depart 
				 * n'est pas egal ˆ 1, et que le deplacement n'est pas inferieur ˆ 0 (que le pion ne recule pas). Si le pion est 
				 * Blanc, les conditions mais sont adaptes a unmouvement negatif et ˆ une ligne de depart egal ˆ 6.
				 */  
