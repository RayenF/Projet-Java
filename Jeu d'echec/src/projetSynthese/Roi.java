...
public class Roi extends Piece{
	...
	public boolean estValide(Deplacement deplacement) {
		/*La somme des déplacement x et y ne devrait jamais ?tre supérieur à deux, pour gérer le cas ou le roi
		 * ferais deux pas dans la m?me direction j'ai ajouter la condition disant que la différence ne devrais jamais 
