...
public class Deplacement {
	 ...
	 * mani?re absolue car le pion à besoin de connaître la direction dans laquelle il se déplace.
	 * @param Prend en param?tre les coordonnees de depart et d'arrive du deplacement
	 */
